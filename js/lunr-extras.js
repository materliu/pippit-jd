 ...
 * Dummy language implementation for lunr which does not do any stemming. Used as fallback when no language is available.
 */
    ...
    return function(lunr) {
        ...
        lunr.noop = function() {
            ...
            if (this.searchPipeline) {
                ...
                this.searchPipeline.add(lunr.noop.stemmer)
            }
        };

        /* lunr trimmer function */
        lunr.noop.wordCharacters = "\S";
        lunr.noop.trimmer = lunr.trimmerSupport.generateTrimmer(lunr.noop.wordCharacters);

        lunr.Pipeline.registerFunction(lunr.noop.trimmer, 'trimmer-noop');

        /* lunr stemmer function */
        lunr.noop.stemmer = (function() {
        ...
        lunr.Pipeline.registerFunction(lunr.noop.stemmer, 'stemmer-noop');

        lunr.noop.stopWordFilter = lunr.generateStopWordFilter([]);

        lunr.Pipeline.registerFunction(lunr.noop.stopWordFilter, 'stopWordFilter-noop');
    };
}))